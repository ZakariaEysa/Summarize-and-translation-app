...
class EnglishTextScreen extends StatelessWidget {
  static const String routeName = "EnglishTextScreen";
  const EnglishTextScreen({super.key});
      ...
      body: Stack(
        ...
        children: [
          Column(
            children: [
              AppBar(
                title: const Text("English Summarization",style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold,color: Colors.white),),
